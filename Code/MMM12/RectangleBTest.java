...
public class RectangleBTest
{
    public static void main(String[] args)
   {
        ...
        System.out.println("Your pointSW & pointNE: " + rec1.getPointSW() + " " + rec1.getPointNE());
        System.out.println("Currect pointSW: (3,7) (6,10)\n\n");
        ...
        System.out.println("-------------");
        System.out.println("Current pointSW & pointNE: " + rec1.getPointSW() + " " + rec1.getPointNE());
        rec1.move(3, 4);
        System.out.println("Your pointSW & pointNE: " + rec1.getPointSW() + " " + rec1.getPointNE());
        System.out.println("Currect pointSW & pointNE: (6,6) (9,10)\n\n");
